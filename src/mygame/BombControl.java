    ...
    public void collision(PhysicsCollisionEvent event) {
        ...
        if (event.getObjectA() == this || event.getObjectB() == this) {
           ...
           spatial.removeFromParent();
            ...
            //Gets list of destructible objects and iterates through
            //them in a for loop
            ...
            System.out.println(dropables);
            //The for each loop shown below is not good for removing elements
            //as you go through the loop. Use iterator class instead!
//            for(Object obj: destructibles){
//                Spatial s = (Spatial)obj;
//                if(s.getName().equals(event.getNodeB().getName())){
...
//                    System.out.println(s.getName()+" has been destroyed!");
//                }
//            }
            for(Iterator it = dropables.iterator(); it.hasNext();){
                ...
                if(s.getName().equals(event.getNodeA().getName())){
                    ...
                    s.getControl(DropTargetControl.class).setEnabled(true);
                     ...
                     //s.getControl(DropTargetControl.class).playThonk(event.getPositionWorldOnA(),event.getAppliedImpulse());
            ...
            if(!dropped){
                ...
                Spatial s = (Spatial)it.next();
                    ...
                    if(s.getName().equals(event.getNodeB().getName())){
                         ...
                         this.app.getStateManager().getState(BulletAppState.class).getPhysicsSpace().removeCollisionObject(event.getObjectB());
                         System.out.println(s.getName()+" has been destroyed!");
                        if((Integer)s.getUserData("IsBillboard")!=null){
                             int m = this.app.getBillBoardManager().billboards.indexOf(s);
                             this.app.getRootNode().detachChildNamed(s.getName()+"text");
                             this.app.getBillBoardManager().boardtextlist.remove(m);
                             this.app.getBillBoardManager().billboards.remove(m);
